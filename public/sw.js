if (!self.define) {
  ...
  self.define = (a, c) => {
    ...
    const r = {}
    const g = (e) => s(e, n),
      t = { module: { uri: n }, exports: r, require: g }
    i[n] = Promise.all(a.map((e) => t[e] || g(e))).then((e) => (c(...e), r))
  }
}
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        ...
        { url: '/_next/static/chunks/150-50471cf98f7b08b5.js', revision: 'hLtoD8QBZm2sEcWP-q_gp' },
        { url: '/_next/static/chunks/152.81654da24b7fb831.js', revision: '81654da24b7fb831' },
        { url: '/_next/static/chunks/172-d8dab36c6ae8f15d.js', revision: 'hLtoD8QBZm2sEcWP-q_gp' },
        { url: '/_next/static/chunks/201.79d7d76ed863dba1.js', revision: '79d7d76ed863dba1' },
        { url: '/_next/static/chunks/247.8a93fb433c8c500b.js', revision: '8a93fb433c8c500b' },
        { url: '/_next/static/chunks/258.b6bcb627b8a819dd.js', revision: 'b6bcb627b8a819dd' },
        { url: '/_next/static/chunks/342.bb863103e2d1d073.js', revision: 'bb863103e2d1d073' },
        { url: '/_next/static/chunks/468-0d7bf2cc0c865f5c.js', revision: 'hLtoD8QBZm2sEcWP-q_gp' },
        { url: '/_next/static/chunks/631-dd331f9c096de892.js', revision: 'hLtoD8QBZm2sEcWP-q_gp' },
        { url: '/_next/static/chunks/642.70e925e18937a669.js', revision: '70e925e18937a669' },
        { url: '/_next/static/chunks/693.32c6a397026db5d1.js', revision: '32c6a397026db5d1' },
        { url: '/_next/static/chunks/742.e32adc0770503279.js', revision: 'e32adc0770503279' },
        { url: '/_next/static/chunks/753.39d0398239fdfffd.js', revision: '39d0398239fdfffd' },
        ...
        {
          url: '/_next/static/chunks/app/_not-found-247b5eb27d9379c6.js',
          revision: 'hLtoD8QBZm2sEcWP-q_gp',
        },
        {
          url: '/_next/static/chunks/app/blob/page-a898f610eacf5d3a.js',
          revision: 'hLtoD8QBZm2sEcWP-q_gp',
        },
        {
          url: '/_next/static/chunks/app/carousel/page-7a2250057e0509cf.js',
          revision: 'hLtoD8QBZm2sEcWP-q_gp',
        },
        {
          url: '/_next/static/chunks/app/horizontal/page-6a797e161a81c57a.js',
          revision: 'hLtoD8QBZm2sEcWP-q_gp',
        },
        {
          url: '/_next/static/chunks/app/layout-e685cef453e9f8b6.js',
          revision: 'hLtoD8QBZm2sEcWP-q_gp',
        },
        {
          url: '/_next/static/chunks/app/page-2d7334bfc09c8019.js',
          revision: 'hLtoD8QBZm2sEcWP-q_gp',
        },
        {
          url: '/_next/static/chunks/b536a0f1-e1bb853a1f969078.js',
          revision: 'hLtoD8QBZm2sEcWP-q_gp',
        },
        { url: '/_next/static/chunks/c15bf2b0.40a621fed3307a59.js', revision: '40a621fed3307a59' },
        {
          url: '/_next/static/chunks/fd9d1056-65b7bc0d513d3dc2.js',
          revision: 'hLtoD8QBZm2sEcWP-q_gp',
        },
        {
        ...
        { url: '/_next/static/chunks/main-fd754e4f7f364ebe.js', revision: 'hLtoD8QBZm2sEcWP-q_gp' },
        {
        ...
        {
          url: '/_next/static/chunks/webpack-767757b24814789d.js',
          revision: 'hLtoD8QBZm2sEcWP-q_gp',
        },
        { url: '/_next/static/css/449c5b6e3fb933a5.css', revision: '449c5b6e3fb933a5' },
        {
          url: '/_next/static/hLtoD8QBZm2sEcWP-q_gp/_buildManifest.js',
          revision: 'e0a21c7d7f93d89dce16df0231dc76f2',
        },
        {
          url: '/_next/static/hLtoD8QBZm2sEcWP-q_gp/_ssgManifest.js',
        ...
        { url: '/manifest.json', revision: '2ed64e8d463482e51d8a5ddf75ba3d9f' },
    ...
    e.registerRoute(
      ({ request: e, url: { pathname: i }, sameOrigin: s }) =>
        '1' === e.headers.get('RSC') &&
    ...
    e.registerRoute(
      ({ request: e, url: { pathname: i }, sameOrigin: s }) =>
        '1' === e.headers.get('RSC') && s && !i.startsWith('/api/'),
      new e.NetworkFirst({
        cacheName: 'pages-rsc',
        plugins: [new e.ExpirationPlugin({ maxEntries: 32, maxAgeSeconds: 86400 })],
      }),
